...
Not here. The L1 system lives at `~/.windsurf/` so it applies globally. This repo tracks the **meta-work**: the building of L1, sprint coordination, retro archive, and self-tracking.
