...
| **Discussed at first supervisor progress-check** (per horus brainstorm §12 amendment 2026-05-19) | Research question; field weights (v2 §5.2); H1–H6 refinement (already pre-registered in v2 §6, 2026-05-08); statistical reporting standards; freeze-date discussion | v2 §4.1 + §12 |
...
| `ADR-NNN-cloud-baselines` | Gemini 2.5 Pro, Sonnet 4.5, GPT-5, LandingAI ADE, Mistral OCR, Gemma 3 | Subset by budget at supervisor progress-check |
...
1. **M2D.5 — `/run-phase experiment` (kickoff)** — scope defined in `~/Projects/horus/docs/prompts/stages/02-brainstorm.md` §8. Execute in order:
   ...
   g. After pilot evidence: schedule first supervisor progress-check meeting + draft agenda materials.
